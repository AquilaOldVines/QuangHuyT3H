    ...
    override fun initView() {
        ...
        with(binding){
            ...
            txtTh2.setOnClickListener {
                ...
                binding.txtTh3.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtTh4.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtTh5.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtTh6.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtTh7.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtCn.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
            }
            ...
            txtTh3.setOnClickListener {
                ...
                binding.txtTh2.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtTh4.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtTh5.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtTh6.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.txtTh7.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
            ...
            btbNhap.setOnClickListener {
                ...
                if(moneyViewHome.text.toString() == ""){
